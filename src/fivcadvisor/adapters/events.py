...
class AgentInitializedEvent(Event):
    ...
    def __init__(self, agent_id: Optional[str] = None, agent_name: Optional[str] = None, **kwargs):
...
class BeforeInvocationEvent(Event):
    ...
    def __init__(self, agent_id: Optional[str] = None, query: Optional[str] = None, **kwargs):
...
class AfterInvocationEvent(Event):
    ...
    def __init__(self, agent_id: Optional[str] = None, result: Optional[Any] = None, **kwargs):
...
class MessageAddedEvent(Event):
    ...
    def __init__(self, message: Optional[str] = None, role: Optional[str] = None, **kwargs):
...
class ToolCalledEvent(Event):
    ...
    def __init__(self, tool_name: Optional[str] = None, tool_input: Optional[Dict[str, Any]] = None, **kwargs):
...
class ToolResultEvent(Event):
    ...
    def __init__(self, tool_name: Optional[str] = None, tool_result: Optional[Any] = None, **kwargs):
...
class ErrorOccurredEvent(Event):
    ...
    def __init__(self, error_message: Optional[str] = None, error_type: Optional[str] = None, **kwargs):
