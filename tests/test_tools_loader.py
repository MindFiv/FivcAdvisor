...
class TestToolsLoaderInit:
    ...
    def test_init_with_retriever(self):
        ...
        try:
            loader = ToolsLoader(tools_retriever=mock_retriever, config_file=config_path)
            
            assert loader.tools_retriever == mock_retriever
            assert loader.tools_names == set()
...
class TestToolsLoaderLoad:
    ...
    def test_load_calls_load_async(self):
        ...
        try:
            ...
            with patch.object(loader, "load_async", new_callable=AsyncMock) as mock_load_async:
                loader.load()
    ...
    async def test_load_async_with_no_servers(self):
        ...
        try:
            ...
            with patch("fivcadvisor.tools.types.loaders.MultiServerMCPClient") as mock_client_class:
    ...
    async def test_load_async_with_tools(self):
        ...
        try:
            ...
            with patch("fivcadvisor.tools.types.loaders.MultiServerMCPClient") as mock_client_class:
                ...
                with patch("fivcadvisor.tools.types.loaders.load_mcp_tools", new_callable=AsyncMock) as mock_load_tools:
                    ...
                    # Verify tool names were tracked
                    assert "tool1" in loader.tools_names
                    assert "tool2" in loader.tools_names
        finally:
            os.unlink(config_path)
...
class TestToolsLoaderCleanup:
    ...
    def test_cleanup_removes_all_tools(self):
        ...
        try:
            ...
            loader.tools_names = {"tool1", "tool2", "tool3"}
            ...
            # Verify tools_names was cleared
            assert loader.tools_names == set()
        finally:
            os.unlink(config_path)
